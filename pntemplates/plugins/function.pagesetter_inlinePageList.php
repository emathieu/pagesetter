...
/**
 * Smarty function to create a templated list of pages.
 *
 * Parameters:
 ...
 */
function smarty_function_pagesetter_inlinePageList($args, &$smarty)
{
  $smarty->caching = 0; // No caching since we refer to a list that will get extended without clearing this cached version

  if (!isset($args['tid']))
    return "Missing 'tid' argument in Smarty plugin 'pagesetter_inlinePageList'";
