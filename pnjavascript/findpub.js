...
function pagesetterFindPub(inputID, pagesetterURL, URLMode, targetMode) //EM: Added URLMode and targetMode for Publication field type
{
//EM  window.open(pagesetterURL+"&targetID="+inputID, "", "width=750,height=315,resizable");
//EM begin: transmit URLMode and targetMode for Publication field type
  var url = pagesetterURL;
  url += "&targetID="+inputID;
  url += "&URLMode="+URLMode;
  url += "&target="+targetMode;
  window.open(url, "", "width=750,height=450,resizable,scrollbars=1");
//EM: end
}
